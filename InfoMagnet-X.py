...
def gather_twitter_info(username):
    url = f"https://api.twitter.com/users/{username}"  # This is a placeholder URL and should be replaced with the correct Twitter API endpoint
    headers = {
...
def gather_twitter_friends(username):
    url = f"https://api.twitter.com/users/{username}/friends"  # This is a placeholder URL and should be replaced with the correct Twitter API endpoint
    headers = {
        "User-Agent": generate_random_user_agent()
    }
    response = requests.get(url, headers=headers)
...
def check_threatening_tweets(username, threatening_keywords):
    url = f"https://api.twitter.com/users/{username}/tweets"  # This is a placeholder URL and should be replaced with the correct Twitter API endpoint
    headers = {
        "User-Agent": generate_random_user_agent()
    }
    response = requests.get(url, headers=headers)
...
def gather_popular_tweets():
    url = "https://api.twitter.com/tweets/popular"  # This is a placeholder URL and should be replaced with the correct Twitter API endpoint
    headers = {
        "User-Agent": generate_random_user_agent()
    }
    response = requests.get(url, headers=headers)
